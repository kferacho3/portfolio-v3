    ...
    <group ref={group} {...props} dispose={null}>
      ...
      >
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          >
            <mesh
              geometry={nodes.Object_154002.geometry}
        ...
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          >
            <mesh
              ...
              material={materials['Texture.007']}
            />
          </group>
        </group>
      </group>
      <group
        position={[8.88, -0.2, 3.62]}
        rotation={[-Math.PI / 2, 0, 0]}
        scale={[1.54, 1.12, 1]}
      >
        <group rotation={[Math.PI / 2, 0, 0]}>
      ...
      >
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          >
            <mesh
              geometry={nodes.Object_38002.geometry}
      ...
      >
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          >
            <mesh
              geometry={nodes.Object_144001.geometry}
      ...
      >
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[-1.1, 4.29, -4.43]} rotation={[0, 0.36, 0]}>
            <mesh
              geometry={nodes.Object_136002.geometry}
