...
export function MeBitUfo(props: GroupProps) {
  ...
  const { nodes, materials, animations } = useGLTF(
    'https://racho-devs.s3.us-east-2.amazonaws.com/roomV2/desktop/meBits/MeBitUFO.glb'
  ) as GLTFResult;
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh
          ...
          position={[-1.701, -0.387, -1.975]}
          rotation={[Math.PI, -0.016, Math.PI]}
          scale={[0.635, 0.866, 0.425]}
        />
        <mesh
          name="UfoPurpleBod1"
          geometry={nodes.UfoPurpleBod1.geometry}
          material={materials.PaletteMaterial005}
          position={[0.306, 0.039, 0.019]}
          rotation={[0, 0, -3.141]}
          scale={[7.63, 1, 7.63]}
        />
        <mesh
