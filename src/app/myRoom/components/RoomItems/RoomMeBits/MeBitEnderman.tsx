...
export function MeBitEnderman(props: GroupProps) {
  ...
  const { nodes, materials, animations } = useGLTF('https://racho-devs.s3.us-east-2.amazonaws.com/roomV2/desktop/meBits/MeBitEnderman.glb') as GLTFResult
          ...
          <group name="3339e04691e7494cb6323f98e276e43afbx" rotation={[Math.PI / 2, 0, 0]}>
            <group name="Object_2">
              <group name="RootNode001">
                <group name="Armature" position={[0, 17.068, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
                ...
                <group name="Camera001" position={[794.567, 182.179, 3639.037]} rotation={[-2.988, 1.34, 2.913]} scale={100}>
                  <group name="Object_9" />
                </group>
                <group name="Light" position={[307.625, 190.386, 299.455]} rotation={[1.89, 0.881, -2.045]} scale={100}>
