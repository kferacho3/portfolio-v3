 ...
 */
export function hasModes(
  module: GameModule
): module is GameModule & Required<Pick<GameModule, 'getModes' | 'setMode'>> {
  return (
    typeof module.getModes === 'function' &&
    typeof module.setMode === 'function'
  );
}
 ...
 */
export function hasSkins(
  module: GameModule
): module is GameModule & Required<Pick<GameModule, 'getSkins' | 'setSkin'>> {
  return (
    typeof module.getSkins === 'function' &&
    typeof module.setSkin === 'function'
  );
}
...
export function hasHUD(
  module: GameModule
): module is GameModule & Required<Pick<GameModule, 'getHUD'>> {
