...
export const CURVE_DEFAULT_CURVATURE = 0.64;
export const CURVE_DEFAULT_CURVATURE_VEL = 1;
export const CURVE_FORWARD_BIAS = 0.12;
export const CURVE_MAX_YAW = 0.9;
export const CURVE_CENTER_PULL = 0.04;
export const CURVE_SEGMENT_RANGE: [number, number] = [24, 46];
export const CURVE_SEGMENT_SHORT_RANGE: [number, number] = [10, 18];
export const CURVE_BOUNDARY_SOFT = TILE_SIZE * 7.2;
export const CURVE_BOUNDARY_HARD = TILE_SIZE * 9.4;
