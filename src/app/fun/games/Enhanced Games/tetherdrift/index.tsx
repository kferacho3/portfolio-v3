...
const TetherDrift: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <NeonDome accentA="#a78bfa" accentB="#031022" />
      ...
      <ScenePostFX boost={(snap.perfectFlash > 0 ? 0.65 : 0) + Math.min(0.9, snap.chain / 18) + (snap.heat / 100) * 0.45} />
      ...
      <PlayerTrail target={playerRef} color="#22d3ee" />
    </>
  );
};
