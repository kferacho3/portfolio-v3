  ...
  return (
    <Html fullscreen>
      <div className="pointer-events-auto absolute inset-0 flex items-center justify-center bg-black/70 text-white backdrop-blur-sm">
        ...
        >
          <div
            className="text-sm uppercase tracking-[0.35em] text-cyan-400/80"
            style={{ fontFamily: '"Geist Mono", monospace' }}
          >
            FluxHop
          </div>
          <h2 className="mt-3 text-3xl font-semibold bg-gradient-to-r from-cyan-400 to-pink-400 bg-clip-text text-transparent">
            Game Over
          </h2>
          ...
          <div className="mt-3 text-xs text-white/50">
            R to restart - Swipe or tap to move
          </div>
        </div>
      </div>
    </Html>
