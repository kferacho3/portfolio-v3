...
export const GAME = {
  ...
  maxLateralSpeed: 8.2,
  groundedXDampNoInput: 24,
  groundedZDamp: 10,
  groundedZDampNoInput: 20,
  landingSnapRange: 0.42,
  landingSnapDamp: 26,
  lateralPointerDeadZone: 0.2,

  visualJumpSpinSpeed: 17.8,
  visualAirSpinSpeed: 8.8,
  visualSpinDampAir: 3.2,
  visualSpinDampGround: 12.5,
  visualPitchFactor: 0.04,
  visualRollFactor: 0.075,
  visualTiltMax: 0.34,
  visualTiltDamp: 11.2,
  visualTiltSettleDamp: 16.4,
