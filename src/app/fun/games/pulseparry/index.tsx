  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-neutral-950 text-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-4 top-4 text-sm opacity-80">PulseParry</div>
        ...
        <div className="absolute inset-0 grid place-items-center bg-black/60">
          <div className="w-[min(420px,92vw)] rounded-xl bg-neutral-900/80 p-6 shadow-2xl backdrop-blur">
            ...
            <p className="mt-2 text-sm leading-relaxed text-white/75">
              One tap = a short shield pulse. Time it to parry incoming shards. Parried shards bounce back
              and score points.
            </p>
            <div className="mt-5 flex items-center gap-3">
              ...
              <div className="text-xs text-white/60">Tap anywhere during play</div>
            </div>
          </div>
        </div>
      )}
  ...
  return (
    <group>
      ...
      <mesh ref={ballRef} position={[0, PLAYER_Y, 0]} castShadow>
        ...
        <meshStandardMaterial color="#e6e6ff" roughness={0.25} metalness={0.15} />
      </mesh>

      {/* Shield */}
      <mesh ref={shieldRef} position={[0, PLAYER_Y, 0]}>
        <sphereGeometry args={[SHIELD_RADIUS, 24, 24]} />
        <meshStandardMaterial color="#7dd3fc" transparent opacity={0.18} roughness={0.1} />
      </mesh>
