    ...
    <Html fullscreen style={{ pointerEvents: 'none' }}>
      ...
      >
        ...
        <div className="absolute top-6 left-0 right-0 flex items-start justify-center">
          <div
            className="text-black text-6xl font-black tracking-tight"
              ...
              <div className="mt-5 grid grid-cols-2 gap-3">
                <div className="rounded-2xl bg-black/5 p-4">
                  ...
                  <div className="mt-1 text-sm text-black/60">
                    Clear levels by dodging wall-blocks.
                  </div>
                </div>
                <div className="rounded-2xl bg-black/5 p-4">
                  <div className="text-sm font-semibold text-black/80">Tip</div>
                  <div className="mt-1 text-sm text-black/60">
                    Switch early—your ball slides, it doesn’t teleport.
                  </div>
                </div>
              </div>
        ...
        {snap.phase === 'gameover' && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="pointer-events-auto w-[min(520px,92vw)] rounded-3xl bg-white/90 p-6 shadow-xl backdrop-blur">
              ...
              <div className="mt-2 text-black/70">
                Tap again and take another run.
              </div>
...
function Scene() {
  ...
  const levelRef = React.useRef<OnePathLevel>(
    onePathState.buildLevel(onePathState.level)
  );
  ...
  const mats = React.useMemo(() => {
    ...
    const obstacle = new THREE.MeshStandardMaterial({
      color: new THREE.Color(COLORS.obstacle),
      roughness: 0.25,
      metalness: 0.0,
    ...
    const portalAlt = new THREE.MeshStandardMaterial({
    ...
    <>
      ...
      <group ref={groupRef}>
        ...
        <mesh
          ...
          material={mats.wall}
          position={[
            -geom.corridorW * 0.5 - geom.wallT * 0.5,
            geom.wallH * 0.5,
            len * 0.5,
          ]}
