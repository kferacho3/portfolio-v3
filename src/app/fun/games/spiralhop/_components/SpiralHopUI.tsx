...
function buttonStyle(primary = false, accent = '#111827'): CSSProperties {
  return {
    ...
    background: primary ? `linear-gradient(135deg, ${accent}, #111827)` : 'rgba(255,255,255,0.75)',
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 12 }}>
              <div style={{ fontSize: 26, fontWeight: 1000, letterSpacing: 0.6 }}>{SPIRAL_HOP_TITLE}</div>
            ...
            <div style={{ marginTop: 10, display: 'flex', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap' }}>
              ...
              <div style={{ fontSize: 14 }}>
                Best combo: <span style={{ fontWeight: 1000 }}>{snap.bestCombo}</span>x
              </div>
            ...
            <div style={{ marginTop: 14, display: 'grid', gap: 12 }}>
              <div style={{ display: 'grid', gap: 8 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button style={buttonStyle(false)} onClick={() => spiralHopState.setBall(prevBall)}>
                      ◀
                    </button>
                    <button style={buttonStyle(false)} onClick={() => spiralHopState.setBall(nextBall)}>
                      ▶
                    </button>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button style={buttonStyle(false)} onClick={() => spiralHopState.setTheme(prevTheme)}>
                      ◀
                    </button>
                    <button style={buttonStyle(false)} onClick={() => spiralHopState.setTheme(nextTheme)}>
                      ▶
                    </button>
                  </div>
                </div>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <button style={{ ...buttonStyle(true, accent), flex: 1, minWidth: 140 }} onClick={() => spiralHopState.start()}>
              ...
              <div style={{ fontSize: 12, lineHeight: 1.4, opacity: 0.72 }}>
                Time your hops and land near the center for combo bonuses. Platforms twist and rise as you go.
              </div>
