...
import { BEST_SCORE_KEY, REVERSE_DURATION, REVERSE_COOLDOWN } from '../constants';
    ...
    <Html fullscreen style={{ pointerEvents: 'none' }}>
      <ArcadeHudShell gameId="conveyorchaos" className="absolute top-4 left-4 pointer-events-auto">
        <ArcadeHudCard className="min-w-[260px]">
          <div className="text-[10px] uppercase tracking-[0.32em] text-white/50">Factory Engineer</div>
          <div className="text-[9px] uppercase tracking-[0.26em] text-white/40">Rotate → Route → Deliver</div>
