...
export const WALL_MODE_LEVELS = [
  // Level 1-2: Beginner - Plain wall, predictable rebounds
  {
    ...
    captureZoneSize: 2.5,
    wallType: 'plain' as const,
    hasMovingPanels: false,
    hasTargetZones: false,
    hasHazardZones: false,
  },
  {
    level: 2,
    streakGoal: 15,
  ...
  // Level 6-10: Advanced - Moving panels, target zones, hazard zones
  {
    ...
    captureZoneSize: 2.0,
    wallType: 'advanced' as const,
    hasMovingPanels: true,
    hasTargetZones: true,
    hasHazardZones: false,
  },
  {
