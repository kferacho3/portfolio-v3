...
const Arena: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <CuboidCollider
          args={[arenaWidth / 2, wallThickness / 2, 2]}
      ...
      >
        <CuboidCollider
          args={[wallThickness / 2, arenaHeight / 2, 2]}
          restitution={wallRestitution}
          friction={wallFriction}
        />
        <mesh>
      ...
      >
        <CuboidCollider
          args={[bottomWallLength / 2, wallThickness / 2, 2]}
          restitution={wallRestitution}
          friction={wallFriction}
        />
        <mesh>
      ...
      <pointLight
        position={[0, arenaHeight / 2, 2]}
        color="#4080ff"
        intensity={0.5}
        distance={15}
      />
      <pointLight
        position={[-arenaWidth / 2, 0, 2]}
        color="#8040ff"
        intensity={0.3}
        distance={10}
      />
