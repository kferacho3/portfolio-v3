...
export function OctaSurgeUI({
  ...
  const showMenuOverlay = snap.phase !== 'playing' || paused;
    ...
    >
      {snap.phase === 'playing' && !paused && (
        <>
          ...
          >
            <div style={{ fontSize: 9, letterSpacing: 1.4, opacity: 0.66 }}>
              SCORE
            </div>
            <div
              style={{
          ...
          >
            ...
            >
              ...
              <br />
              Runner {OCTA_RUNNER_SHAPE_LABEL[snap.runnerShape]}
              <br />
      ...
      {showMenuOverlay && (
        <div
          style={{
            ...
            pointerEvents: 'auto',
            background:
              'radial-gradient(circle at 15% 14%, rgba(72,208,255,0.1), transparent 38%), radial-gradient(circle at 85% 84%, rgba(255,170,92,0.14), transparent 40%)',
          }}
        >
          <div
            style={{
              ...
              background:
                'linear-gradient(120deg, rgba(12,20,31,0.9), rgba(6,10,16,0.84))',
          ...
          >
            ...
            >
              ...
              >
                {paused && snap.phase === 'playing'
                  ? 'Paused // Control Console'
            ...
            <div style={{ padding: '16px 24px 22px' }}>
              ...
              >
                ...
                >
                  Smooth Classic Path // Signature Tile Grid Set
                </div>
                <div
                  style={{
                    marginTop: 5,
                ...
                >
                  Alloy, Prismatic, GridForge, Diamond Tess, Sunken Steps, and Ripple have unique high-contrast patterns for immediate readability.
                </div>
                <div
                  style={{
                    marginTop: 8,
                ...
                >
                  <button
                    ...
                    style={{ ...buttonBase, fontSize: 11, padding: '8px 12px' }}
                  >
                    Prev Style
                  </button>
                  <button
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: active
                            ...
                            : '1px solid rgba(255,255,255,0.2)',
                          background: active
                            ? 'linear-gradient(135deg, rgba(158,241,255,0.34), rgba(255,188,126,0.25))'
                            : 'rgba(255,255,255,0.05)',
                        }}
                      >
                        {OCTA_RUNNER_SHAPE_LABEL[shape]}
                      </button>
                    );
                  })}
                </div>
              ...
              >
                ...
                >
                  Obstacle and platform silhouettes are now heavily color-coded and pulsed so you can read intent instantly and anticipate moves.
                </div>
                  ...
                  {paused && snap.phase === 'playing' && (
                    <button
                      ...
                      style={{
                        ...
                        fontSize: 12,
                        background:
                          'linear-gradient(135deg, rgba(128,241,255,0.42), rgba(112,208,255,0.32))',
                      }}
                    >
                      Resume Run
                    </button>
