            ...
            {(['ship', 'ufoMini'] as const).map((c) => (
              <button
                ...
                style={{
                  padding: '0.5rem 1rem',
                  borderRadius: '8px',
                  border: snap.character === c ? '1px solid #00ffff' : '1px solid rgba(255,255,255,0.2)',
                  background: snap.character === c ? 'rgba(0,255,255,0.2)' : 'transparent',
                  color: snap.character === c ? '#00ffff' : 'rgba(255,255,255,0.6)',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                }}
              >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            ...
            {snap.score >= snap.highScore && snap.score > 0 && (
              <div style={{ color: '#22d3ee', fontSize: '0.875rem' }}>NEW HIGH SCORE!</div>
            )}
