...
export const KETCHAPP_GAME_SPECS: Record<KetchappGameId, KetchappGameSpec> = {
  ...
  tetherdrift: {
    ...
    input: 'hold',
    tutorial: 'Hold to tether. Release to slingshot.',
    failCondition: 'fall',
  ...
  trace: {
    ...
    verb: 'Turn trace',
    input: 'tap',
    tutorial: 'Tap near corners to keep tracing.',
  ...
  flipbox: {
    ...
    verb: 'Stack',
    input: 'tap',
    tutorial: 'Tap to stack blocks with overlap.',
    failCondition: 'fall',
  ...
  portalpunch: {
    ...
    verb: 'Throw',
    input: 'tap',
    tutorial: 'Tap to throw before hitting knives.',
    failCondition: 'timing miss',
  ...
  conveyorchaos: {
    ...
    verb: 'Swap bins',
    input: 'tap',
    tutorial: 'Tap to swap bins before landing.',
    failCondition: 'collision',
  ...
  slipstream: {
    ...
    verb: 'Dodge',
    input: 'tap',
    tutorial: 'Tap to cycle lanes and dodge.',
    failCondition: 'collision',
    chunkProfile: 'lane-switch',
    endlessFirst: true,
  },
  ...
  pulseparry: {
    ...
    verb: 'Jump pulse',
    input: 'tap',
    tutorial: 'Tap to jump when pulse converges.',
    failCondition: 'timing miss',
    chunkProfile: 'timing-defense',
    endlessFirst: true,
  },
  orbitlatch: {
    id: 'orbitlatch',
    title: 'Orbit Latch',
    verb: 'Flip shield orbit',
    input: 'tap',
    tutorial: 'Tap to reverse shield direction.',
    failCondition: 'collision',
