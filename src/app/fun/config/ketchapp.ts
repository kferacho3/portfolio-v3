...
export const KETCHAPP_GAME_SPECS: Record<KetchappGameId, KetchappGameSpec> = {
  polarity: {
    ...
    verb: 'Flip charge',
    input: 'tap',
    tutorial: 'Tap to flip charge and swap rails.',
  ...
  tetherdrift: {
    id: 'tetherdrift',
    title: 'Tether Drift',
    verb: 'Tether and release',
    input: 'hold',
    tutorial: 'Hold to tether. Release to drift.',
    failCondition: 'fall',
  ...
  trace: {
    ...
    verb: 'Trace path',
    input: 'drag',
    tutorial: 'Drag to stay on the line.',
    failCondition: 'leave path',
  ...
  flipbox: {
    ...
    verb: 'Flip',
    input: 'tap',
    tutorial: 'Tap to flip onto the next platform.',
    failCondition: 'fall',
  ...
  portalpunch: {
    ...
    verb: 'Warp swap',
    input: 'tap',
    tutorial: 'Tap to punch a portal and swap.',
    failCondition: 'collision',
    chunkProfile: 'lane-switch',
    endlessFirst: true,
  },
  conveyorchaos: {
    ...
    verb: 'Switch route',
    input: 'tap',
    tutorial: 'Tap to switch the next junction.',
    failCondition: 'collision',
  ...
  slipstream: {
    ...
    verb: 'Swap lanes',
    input: 'tap',
    tutorial: 'Tap to switch lanes. Ride the stream.',
    failCondition: 'collision',
    chunkProfile: 'lane-switch',
    endlessFirst: true,
  },
  runeroll: {
    ...
    verb: 'Rotate rune',
    input: 'tap',
    tutorial: 'Tap to rotate. Match the rune.',
  ...
  pulseparry: {
    ...
    verb: 'Parry',
    input: 'tap',
    tutorial: 'Tap to parry the pulse.',
    failCondition: 'timing miss',
    chunkProfile: 'timing-defense',
    endlessFirst: true,
  },
  orbitlatch: {
    ...
    verb: 'Latch',
    input: 'tap',
    tutorial: 'Tap to latch to the next orbit.',
    failCondition: 'miss latch',
